...
A function is made out of line(s) of code and it knows how to deal with a specific task. Usually, a function has a name (. So, we can call it using its name whenever you needs its functionality.
